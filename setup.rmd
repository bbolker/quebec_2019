...
```{r pkg1,eval=FALSE}
## modeling packages
mod_pkgs <- c("bbmle", "optimx", "nloptr", "Derivs", "dfoptim", "alabama", "minqa", "subplex", "nlsr", "minpack.lm", "DEoptim")
## miscellaneous/data manipulation
data_pkgs <- c("benchmark", "devtools", "pkgbuild", "emdbook",
               "plyr", "reshape2", "tidyverse")
## graphics
